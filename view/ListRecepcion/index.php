...
?>
    ...
    <body>
        ...
        <div id="layout-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Recepción - Vista General de Habitaciones</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="recepcion-tabcontent" class="tab-content text-muted">
                                        ...
                                        <div class="tab-pane active" id="tab-todos" role="tabpanel">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row g-3 g-xl-1 row-cols-xxl-5 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1" id="todos-cards-row"></div>
                                                </div><!-- end col -->
                                            </div><!-- end row -->
                                        </div>
                                        <br>
            ...
            <script src="viewrecepcion.js"></script>
    </body>
