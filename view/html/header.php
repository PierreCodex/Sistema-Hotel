...
$menu = new Menu();
$tipoUsuarioResult = $menu->get_tipo_usuario_descripcion($_SESSION["IdRol"]);
$tipoUsuarioDescripcion = $tipoUsuarioResult['Descripcion'] ?? 'Usuario';
?>
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="../../assets/images/logo-dark.png" alt="" height="77">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $_SESSION["Nombre"]?> <?php echo $_SESSION["Apellido"]?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?php echo $tipoUsuarioDescripcion; ?></span>
                            </span>
                        </span>
                    </button>
